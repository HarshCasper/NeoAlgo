...
int main()
{
    ...
    do// This is will generate a menu and perform the operation acc. to your choice. You will get clear when you will run this or can see README file attach to this folder to have a glimpse of it
    {
