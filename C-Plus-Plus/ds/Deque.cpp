/************************************************************************
Double Ended Queue (deque) is bidirectional Queue data can be insert and remove data from both(front and rear) the ends it can be use to implement stack and queue data 
structure
*************************************************************************
