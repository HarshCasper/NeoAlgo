...
int main()                  //  Main() function begins here 
{
   ...
   do{
       ...
       {
           case 1:
           Insert_1();              //inserting values in List 1
           break;
           
           case 2:
           Insert_2();              //inserting values in List 2
           break;
           
           case 3:
           Display_All();           //returns the list
           break;
           
           case 4:
           Intersect();             //this function is used to intersect both list as per user's choise
           break;
           
           case 6:
           cout<<"Point Of Intersection : "<<Find_Intersection();       // returns the point of intersection  
           break;
