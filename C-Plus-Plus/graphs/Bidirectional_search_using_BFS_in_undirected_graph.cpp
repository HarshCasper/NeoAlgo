...
int bidirectional_search(int sv, int tv, vector<int> graph[], int n, vector<bool>& visitedF,
...
int main()
{
    ...
    int intersection_node
        = bidirectional_search(sv, tv, graph, vertices, visitedF, visitedB, parentF, parentB);
