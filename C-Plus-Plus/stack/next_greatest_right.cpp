/*Next greatest element to the right of each element in the array
 ...
 -->If the stack is empty, then no element to the right is greater than the present element, for example, for the last element
 -->If the stack is not empty but the element present at the top of the stack is not greater than the current element then, pop the stack till either the stack is not empty or the top element of stack is greater than the current element
