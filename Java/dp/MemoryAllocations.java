 ...
 * 
 * 
 * Press 1 to simulate first-fit memory allocation Press 2 to simulate best-fit
 * memory allocation Press 3 to simulate worst-fit memory allocation Press 4 to
 * exit
 * 
 * 
 * Enter the choice 2 Enter the number of memory blocks 5 Enter the size of each
 * memory block 10 15 5 9 3 Enter the number of processes 4 Enter the size of
 * each process 1 4 7 12 Best-Fit Memory Allocation
 * 
 * Process_no Process_size Block_no Block_size Fragment 0 1 4 3 2 1 4 2 5 1 2 7
 * 3 9 2 3 12 1 15 3
 * 
 * Enter the choice 3 Enter the number of memory blocks 5 Enter the size of each
 * memory block 5 4 3 6 7 Enter the number of processes 4 Enter the size of each
 * process 1 3 5 3
 * 
 * Worst-Fit Memory Allocation
 * 
 * File Number File Size Block Number Block Size Fragment 0 1 4 7 6 1 3 0 5 0 2
 * 5 0 5 0 3 3 0 5 0
 * 
 * Enter the choice 1 Enter the number of memory blocks 3 Enter the size of each
 * memory block 12 7 4 Enter the number of processes 3 Enter the size of each
 * process 7 4 9 First-Fit Memory Allocation Block no. size process no. size
 * 
 * 1 12 1 7 2 7 2 4 3 4 Not allocated
 * 
 * 
 * 
 * 
