...
class Rectangle_cutting{
    ...
    public static int cutting(int a,int b)
    {
    ...
    public static int cutting_iterative(int a,int b)
    {
    ...
    public static void main(String args[])
    {
        ...
        System.out.println(cutting(a,b));//call to the function to find the answer using memorization.
        System.out.println(cutting_iterative(a,b));//call to the function to find the answer using memorization.
        sc.close();        
    }
}
