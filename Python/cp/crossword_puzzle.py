...
def solveCrossword(crossword0, words0, index0, wordfill0):
    '''This function helps to solve the puzzle'''
...
def removeHorizontally(i1, j1, crossword1, words1, index1, wordfill1):
    '''This function will remove the word if it is placed in wrong position'''
...
def insertHorPoss(i2, j2, crossword2, words2, index2, wordfill2):
    '''This function will insert the word horizontally'''
    word = words2[index2]
    wordIndex = 0
    initial_j = j2
    while j2 < 10:
...
def insertVerPoss(i3, j3, crossword3, words3, index3, wordfill3):
    '''This function will insert the word vertically'''
    word = words3[index3]
    wordIndex = 0
    initial_i = i3
    while i3 < 10:
...
def printCrossword(crossword5):
    '''This function will print the crossword puzzle'''
    for i5 in range(10):
        for j5 in range(10):
