"""
Purpose:The problem is to find minimum possible time to reach the end by using the lines/routes and nodes.

Problem explanation: 
    
    Consider two assembly lines 'A' and 'B' numbered from 'A1 to An' and 'B1 to Bn' respectively.
    'In1' and 'In2' are two possible where an objects enters and 'Out1' and 'Out2' are two exits after assembling parts.
    ...
    *(arrow) = points toward
    ...
    Let 'e1' and 'e2' be entry time from 'In1' and 'In2' and 'ex1' and 'ex2' be out time for 'Out1' and 'Out2'.
    Let 'tAn' be the time taken at 'An' node of assembly line A and 'tBn' at 'Bn' node of assembly line B.
    Let transiton time from one assembly line to other be tAi,j and tBi,j for line 'A' and 'B' resp.
...
def assemblyLineScheduling(line, transactionTime, inTime, outTime):
    ...
    # taking the minimum of nodes of both the lines and updating the pathC
