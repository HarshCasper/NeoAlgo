...
Tiling problem 2xN
Problem Statement:
Given a 2 x n board and tiles of dimension 2 x 1, count the number of ways to tile the given board using the 2 x 1 tiles.
...
def numberOfWays(num):
	...
	if num < 2:
		return 1
	# temporary list to store the number of ways to fill 2xi grid
	ways = [None] * (num + 1)
	ways[1] = ways[2] = 1
