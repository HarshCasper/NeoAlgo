class my_stack:
    ...
    #After enqueuing in my_queue1 every element of my_queue2 is dequeued and enqueued in my_queue1.
...
if __name__ == '__main__':
 object1 = my_stack()
 for i in range (1,6):
    print('Value pushed into stack is :',i)
    object1.push(i)
 print('')
 for i in range (0,6):
    if object1.isempty():
...
"""
result-
Value pushed into stack is : 1
Value pushed into stack is : 2
Value pushed into stack is : 3
Value pushed into stack is : 4
Value pushed into stack is : 5
