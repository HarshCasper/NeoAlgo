...
for i in range(1,8):
	print(tree.get_node_depth(tree.root, i, 0)) # Should print : 0 1 1 2 2 2 2

### Printing the maximum depth of the tree
print("Maximum Depth: ", tree.get_maximum_depth(tree.root, 0)) # Should print: 2

### Print -1 for the depth if the node is not present in the tree
print("If element not present", tree.get_node_depth(tree.root, 10, 0)) # Should print: -1
