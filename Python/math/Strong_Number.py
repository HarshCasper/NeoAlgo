"""
Basically a strong number is number in which sum of factorial of each digit of the number is equal to that number
...
In the end if number and the sum obtained is equal then it is a Strong number otherwise not
"""
