...
Purpose: Given an array A of length N containing distinct integers from 1
        to N. If we make 2 sets containg N numbers, one arranged serially
...
Intution: This is a typical problem for Divide and Conquer algorithm also
            refered to as the inversion problem.
        ...
        2. Create a function merge that counts the number of inversions when
            ...
            is the index for first half and j is an index of the second half.
